...
export const pageQuery = graphql`
  query($filter: GhostPostFilterInput) {
    Aadhaar: ghostPost(title: { eq: "The Foundation: Aadhaar" }) {
      excerpt
      title
      id
      slug
    ...
    Title_IX: ghostPost(title: { eq: "Title IX's Constant Cycle of Crisis" }) {
      excerpt
      title
      id
      slug
    ...
    Not_Sure: ghostPost(title: { eq: "Title IX's Constant Cycle of Crisis" }) {
      excerpt
      title
      id
      slug
